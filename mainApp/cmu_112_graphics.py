...
class App(object):
    ...
    def _redrawAllWrapper(app):
        ...
        if ('deferredRedrawAll' in app._afterIdMap): return
    ...
    def run(app):
        ...
        if (App._theRoot is None):
            ...
            App._theRoot.protocol('WM_DELETE_WINDOW', lambda: App._theRoot.app.quit())
...
print(f'Loaded cmu_112_graphics')
