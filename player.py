...
class Player(object):
    ...
    def attackWithMouse(self, app, x, y):
        ...
        ##########
        app.character.attackingCounter = 0
        app.character.attacking = True
        ##########
        radius = 8
    ...
    def physicalAttack(self, app):
        ...
        app.character.physicalAttackCounter = 0
        app.character.physicalAttacking = True
...
def playerMovement(app, key):
    if key == 'w':
        ...
        app.character.isRunning = True
        app.character.physicalAttacking = app.character.attacking = False
    elif key == 's':
        app.player.cy += app.player.movementSpeed
        if inBoundsOfRocks(app): app.player.cy -= app.player.movementSpeed
        app.character.isRunning = True
        ...
        app.character.isRunning = True
        app.character.physicalAttacking = app.character.attacking = False
        if not app.character.flipped:
            app.character.flipped = True
            app.character.flipSpriteSheet(app.character.runningSprites)
            app.character.flipSpriteSheet(app.character.attackSprites)
            app.character.flipSpriteSheet(app.character.idleSprites)
            app.character.flipSpriteSheet(app.character.physicalAttackSprites)
        ...
        app.character.isRunning = True
        app.character.physicalAttacking = app.character.attacking = False
        if app.character.flipped:
            app.character.flipped = False
            app.character.flipSpriteSheet(app.character.runningSprites)
            app.character.flipSpriteSheet(app.character.attackSprites)
            app.character.flipSpriteSheet(app.character.idleSprites)
            app.character.flipSpriteSheet(app.character.physicalAttackSprites)
